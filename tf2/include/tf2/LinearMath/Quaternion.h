...
/**@brief The Quaternion implements quaternion to perform linear algebra rotations in combination
 * with Matrix3x3, Vector3 and Transform. */
class Quaternion : public QuadWord {
 public:
  ...
  /**@brief Return the angle [0, Pi] of rotation represented by this quaternion along the shortest
   * path */
  TF2_PUBLIC
  ...
  /**@brief Return the quaternion which is the result of Spherical Linear Interpolation between this
   * and the other quaternion
   * @param q The other quaternion to interpolate with
   * @param t The ratio between this and q to interpolate.  If t = 0 the result is this, if t=1 the
   * result is q. Slerp interpolates assuming constant velocity.  */
  TF2_PUBLIC
...
TF2SIMD_FORCE_INLINE Quaternion slerp(const Quaternion& q1, const Quaternion& q2,
                                      const tf2Scalar& t) {
