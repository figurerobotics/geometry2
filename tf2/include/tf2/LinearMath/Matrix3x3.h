...
/**@brief The Matrix3x3 class implements a 3x3 rotation matrix, to perform linear algebra in
 * combination with Quaternion, Transform and Vector3. Make sure to only include a pure orthogonal
...
class Matrix3x3 {
  ...
  */
  ...
  TF2_PUBLIC
  Matrix3x3(const tf2Scalar& xx, const tf2Scalar& xy, const tf2Scalar& xz, const tf2Scalar& yx,
   ...
   * @param rot stores the rotation from the coordinate system in which the matrix is diagonal to
   * the original coordinate system, i.e., old_this = rot * new_this * rot^T.
   * @param threshold See iteration
   * @param iteration The iteration stops when all off-diagonal elements are less than the threshold
   * multiplied by the sum of the absolute values of the diagonal, or when maxSteps have been
   * executed.
   *
