...
/**@brief The Transform class supports rigid transforms with only translation and rotation and no
 *scaling/shear. It can be used in combination with Vector3, Quaternion and Matrix3x3 linear algebra
 *classes. */
class Transform {
 ...
 public:
  ...
  explicit TF2SIMD_FORCE_INLINE Transform(const Quaternion& q,
                                          const Vector3& c = Vector3(tf2Scalar(0), tf2Scalar(0),
                                                                     tf2Scalar(0)))
   ...
   * @param m A pointer to a 15 element array (12 rotation(row major padded on the right by 1), and
   * 3 translation */
  TF2_PUBLIC
